...
export const YOUTUBE_SEARCH_BY_KEYWORD_API=`https://www.googleapis.com/youtube/v3/search?part=snippet&chart=mostPopular&maxResults=20&q=(mykeyword)&type=video&key=${process.env.REACT_APP_GOOGLE_API_KEY}`